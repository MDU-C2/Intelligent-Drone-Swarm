...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
        Jira & Tracking progress, manage activities, and break activities into tasks\\
        \hline
        ...
        \hline
        SharePoint & \makecell{Storage for larger files, documents waiting for review,\\ protocols, and documents less suited for GitHub} \\
        \hline
