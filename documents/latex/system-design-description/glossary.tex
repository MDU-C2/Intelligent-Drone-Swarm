...
\newglossaryentry{rumourmill}
{
        name=Rumour Mill,
        description={Method to spread messages in a Swarm}
}

\newglossaryentry{searcharea}
{
        name=Search Area,
...
{
        name=sector,
        description={Subdivision of a \gls{searcharea}}
}

\newglossaryentry{hotregion}
{
        name=Hot Region,
...
\newglossaryentry{secmarket}
{
        name=Sector Allocation Market,
        description={Method to distribute Sectors of a Search Area}
}

\newglossaryentry{searchmana}
{
        name=Search Manager,
...
{
        name=UUID,
        description={A universally unique identifier (UUID) is a number of bits intended to be a unique identifier for objects in data systems}
}
...
\newglossaryentry{arp1}
{
        name=ARP4761A,
        description={Aerospace Recommended Practice (ARP) providing guidelines for conducting the safety assessment process on civil aircraft systems and equipment, covering techniques such as \acrshort{fha}, \acrshort{fmea}, and \acrshort{fta} to support system safety analysis throughout the development lifecycle}
}
...
\newglossaryentry{actdia}
{
        name=Activity Diagram,
        description={A visual representation of a workflow, showing the sequence of actions and decisions within a process}
}

\newglossaryentry{statedia}
{
        name=State Diagram,
        description={A visual representation of a state machine, showing a system's possible states and the transitions between them triggered by events}
}
...
\newacronym{rmp}{RMP}{Requirements Management Plan}
...
\newacronym{fmu}{FMU}{Fault Management Unit}
\newacronym{raci}{RACI}{Responsible, Accountable, Consulted, and Informed}
\newacronym{fanet}{FANET}{Flying \Gls{adhoc} Network}
...
%\newacronym{il}{IL}{Integrity Level}
