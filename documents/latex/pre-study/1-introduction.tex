...
The contribution of the project team will be to create a decentralised replanning protocol that allows a degraded UAV to hand over its tasks, assume a secondary role, and allow the swarm to reach consensus on what to do – all validated in simulation with fault injection.
