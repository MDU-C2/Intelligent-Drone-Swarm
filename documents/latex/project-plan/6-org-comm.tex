...
\Cref{tab:project-roles} details what responsibilities, authorities, and dependability focus all main roles in the project have.
\begin{table}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{kanban.png}
