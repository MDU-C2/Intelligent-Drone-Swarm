...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|}
        ...
        \hline
        SharePoint & \makecell{Documents not for public use, along with documents waiting\\ for review, and protocol templates.} \\
        \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{phases-study-guide-V2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{phases-general-model-V2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{phases-modified-model-V2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{V-model-full-modified-V2.png}
