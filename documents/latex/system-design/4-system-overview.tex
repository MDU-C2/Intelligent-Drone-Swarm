...
A new agent must first be initialised (\cref{fig:ad-new-agent-init}) before flying to the search area and attempt to join the swarm (\cref{fig:ad-new-agent}). A larger version of \cref{fig:ad-new-agent} can be found in \cite{SD-22}.
\begin{figure}[H]
    \centering
