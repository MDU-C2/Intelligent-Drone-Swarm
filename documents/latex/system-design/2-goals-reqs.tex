...
A detailed mapping from goals and requirements to system design elements (SD-xx) is maintained in the project's requirements database. 

A high level mapping from goals and requirements to sections in this document is the following:
\begin{itemize}
