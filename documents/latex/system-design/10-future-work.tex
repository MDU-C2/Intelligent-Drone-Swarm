...
\begin{itemize}
    ...
    \begin{itemize}
        \item[$\circ$] Agent positions and health statuses.
        \item[$\circ$] Which sectors are assigned / in progress / completed.
        \item[$\circ$] Agents returning for battery change.
        \item[$\circ$] Subject found / confirmed events.
    \end{itemize}
...
\begin{itemize}
    \item Communication relay positioning: Selecting optimal relay positions based on neighbourhood geometry or sector layout.
    \item Search assistance: Using partially degraded agents to search sectors owned by healthy agents.
\end{itemize}
