...
Primary roles are allowed fully equipped and fully operational agents.
...
Secondary roles are allowed partially equipped and/or partially operational agents.
...
The Agent Task \& Role Allocation layer is implemented as a state machine (\cref{fig:stateflow,fig:fully-op,fig:partially-op}). Each agent transitions between states based on health events, \gls{sector} allocation, and \gls{rumourmill} decisions.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{SD-27_SD - Fully Operational 1.0.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{SD-26_SD - Partially Operational 1.0.png}
